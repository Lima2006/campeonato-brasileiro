...
export type ChampionshipTabs = "partidas" | "jogadores";
interface ChampionshipTableHeaderProps {
  className?: string;
}
const ChampionshipTableHeader: React.FC<ChampionshipTableHeaderProps> = ({
  className,
}) => {
  return (
    <Column className="bg-primary text-white shadow-md shadow-gray-400">
      <Row
        className={classNames(
          "h-16 w-full p-4 items-center text-lg",
          className
        )}
      >
        <img
          ...
          alt="Logo"
        />
        <Text>Brasileirão Série A</Text>
      </Row>
      <ul className="flex h-12">
        <ChampionshipTableTab tabId="partidas">Partidas</ChampionshipTableTab>
        <ChampionshipTableTab tabId="jogadores">Jogadores</ChampionshipTableTab>
      </ul>
    </Column>
  );
};

export default ChampionshipTableHeader;
